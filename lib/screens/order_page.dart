          ...
          child: Column(
            ...
            children: [
              ...
              orderPathIndicator(
                  ...
                  LatLng(
                      order.originPoint.latitude, order.originPoint.longitude),
                  LatLng(order.destinationPoint.latitude,
                      order.destinationPoint.longitude),
                  Device.screenType == ScreenType.tablet && Platform.isIOS),
                        ...
                        Expanded(
                          child: moreItem(context,
                            ...
                            showAlertDialog(context,
                                title: "إلغاء الطلب",
                                content: order.paymentOption !=
                                        "الدفع الإلكتروني"
                                    ? "هل أنت متأكد من إلغاء الطلب؟"
                                    : "هل أنت متأكد من إلغاء الطلب؟ سيتم إرجاع المبلغ المدفوع إلى المحفظة",
                                onOk: () {
